...
@Component
@Scope("prototype")
public class RestrictionInstructions extends ElementXML {

    private static final String S1000D_RI = "Restriction Instructions: ";
    ...
    public String toHtml() {
        ...
        Element span = div.appendElement(HTML_SPAN).text(S1000D_RI);
        span.addClass("bold");
