...
@Component
@Scope("prototype")
public class CloseRqmts extends ElementXML {

    private static final String S1000D_CLOSEREQS= "Close Requirements";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_CLOSEREQS).addClass(this.getClass().getSimpleName());
