...
@Component
@Scope("prototype")
public class ReqSupplies extends ElementXML {

    private static final String S1000D_REQSUPPLIES= "Requirements Supplies";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_REQSUPPLIES).addClass(this.getClass().getSimpleName());
