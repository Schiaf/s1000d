...
@Component
@Scope("prototype")
public class ReqPersons extends ElementXML {

    private static final String S1000D_REQPERSONS= "Required Persons";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_REQPERSONS).addClass(this.getClass().getSimpleName());
