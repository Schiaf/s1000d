...
@Component
@Scope("prototype")
public class PersonCategory extends ElementXML {
    ...
    public String toHtml() {
        ...
        List<String> usedAttributes = Arrays.asList("personCategoryCode");
        td.text(this.getAttribute("personCategoryCode"));
        this.appendChildrenToElement(td, usedAttributes);
        return doc.toString();
    }
