...
@Component
@Scope("prototype")
public class NoSpares extends ElementXML {

    private static final String S1000D_NOSPARE = "No Spares";
    ...
    public String toHtml() {
        ...
        Element div = body.appendElement(HTML_DIV).text(S1000D_NOSPARE).addClass(this.getClass().getSimpleName());
