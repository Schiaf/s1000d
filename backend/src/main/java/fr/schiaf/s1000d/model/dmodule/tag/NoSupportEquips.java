...
@Component
@Scope("prototype")
public class NoSupportEquips extends ElementXML {

    private static final String S1000D_NOSUPPORT= "No Support Equipment";
    ...
    public String toHtml() {
        ...
        Element div = body.appendElement(HTML_DIV).text(S1000D_NOSUPPORT).addClass(this.getClass().getSimpleName());
