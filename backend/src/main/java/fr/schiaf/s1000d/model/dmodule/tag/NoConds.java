...
@Component
@Scope("prototype")
public class NoConds extends ElementXML {

    private static final String S1000D_NOCONDS= "No Conditions";
    ...
    public String toHtml() {
        ...
        Element div = body.appendElement(HTML_DIV).text(S1000D_NOCONDS).addClass(this.getClass().getSimpleName());
