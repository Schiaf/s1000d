...
@Component
@Scope("prototype")
public class NoSafety extends ElementXML {

    private static final String S1000D_NOSAFETY= "No Safety";
    ...
    public String toHtml() {
        ...
        Element div = body.appendElement(HTML_DIV).text(S1000D_NOSAFETY).addClass(this.getClass().getSimpleName());
