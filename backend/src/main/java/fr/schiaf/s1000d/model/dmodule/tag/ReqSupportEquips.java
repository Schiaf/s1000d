...
@Component
@Scope("prototype")
public class ReqSupportEquips extends ElementXML {

    private static final String S1000D_REQSUPPORT= "Requirements Support Equipment";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_REQSUPPORT).addClass(this.getClass().getSimpleName());
