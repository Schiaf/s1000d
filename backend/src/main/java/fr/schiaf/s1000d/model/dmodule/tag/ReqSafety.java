...
@Component
@Scope("prototype")
public class ReqSafety extends ElementXML {

    private static final String S1000D_REQSAFETY= "Requirements Safety";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_REQSAFETY).addClass(this.getClass().getSimpleName());
