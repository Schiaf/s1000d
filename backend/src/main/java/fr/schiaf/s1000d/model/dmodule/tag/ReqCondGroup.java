...
@Component
@Scope("prototype")
public class ReqCondGroup extends ElementXML {

    private static final String S1000D_REQCOND= "Requirements Condition";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_REQCOND).addClass(this.getClass().getSimpleName());
