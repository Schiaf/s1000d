...
@Component
@Scope("prototype")
public class ReqSpares extends ElementXML {

    private static final String S1000D_REQSPARES= "Requirements Spares";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_REQSPARES).addClass(this.getClass().getSimpleName());
