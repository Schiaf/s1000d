...
@Component
@Scope("prototype")
public class PreliminaryRqmts extends ElementXML {

    private static final String S1000D_PRELREQS= "Preliminary Requirements";
    ...
    public String toHtml() {
        ...
        body.appendElement(HTML_H1).text(S1000D_PRELREQS).addClass(this.getClass().getSimpleName());
