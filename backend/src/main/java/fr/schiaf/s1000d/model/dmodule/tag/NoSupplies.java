...
@Component
@Scope("prototype")
public class NoSupplies extends ElementXML {

    private static final String S1000D_NOSUPPLY= "No Supplies";
    ...
    public String toHtml() {
        ...
        Element div = body.appendElement(HTML_DIV).text(S1000D_NOSUPPLY).addClass(this.getClass().getSimpleName());
